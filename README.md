...
- 作为会话视图标签，与「对话」「轨迹」并列显示在会话标题栏；点击「工作区文件」直接在主区域打开；
...
```bash
dsh plugin --profile demo add ./dsh-external-workspace-browser-0.8.0.tgz
# 或从 GitHub 安装
dsh plugin --profile demo add github:supengpeng/dsh-workspace-browser#v0.8.0
```
